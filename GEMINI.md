...
- [ ] **5.2 Graceful Shutdown:** Implement `os/signal` handling to ensure the SQLite database closes correctly when the process is stopped.

-----

### Phase 6: Testing & Validation
- [ ] **6.1 Unit Tests:** Create tests for every function and wrapper.  Test for correct responses with both successful requests and unsuccessful requests.
...
- [ ] **6.2 Integration Test:** Write tests that use `curl` to simulate the full flow: Register -> Auth -> Put Progress -> Get Progress.
